...
urlpatterns = [
    ...
    path("edit_organisation/<int:organisation_id>/", views.view_organisation, name="edit_organisation"),  # TODO: Implement edit_organisation
    path("delete_organisation/<int:organisation_id>/", views.delete_organisation, name="delete_organisation"),
    path("view_organisation/<int:organisation_id>/add_member/", views.add_member, name="add_member"),
    path("remove_member/<int:organisation_id>/<int:user_id>", views.remove_member, name="remove_member"),
